			...
			<div class="center-sign">
				<div class="panel card-sign">
					<div class="card-body">
						...
						<form action="<?php echo base_url()?>login/loginLockUser" method="post">
							...
							<div class="form-group mb-3">
								<div class="input-group">
                                    ...
                                    <input id="email" name="email" type="hidden" value="<?php print $this->session->userdata('email') ?>"/>
							...
							<div class="row">
								<div class="col-6">
									<p class="mt-1 mb-3">
										<a href="<?php echo base_url(); ?>logout">Not <?php print $this->session->userdata('name') ?>?</a>
									</p>
								</div>
								<div class="col-6">
