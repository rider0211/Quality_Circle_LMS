  ...
  padding: 0 20px 2px 20px;">
            ...
            <div class="panel card-sign">
                <div class="card-title-sign mt-3 text-right">
                    <h2 class="title text-uppercase font-weight-bold m-0"><i class="fas fa-user mr-1"></i> <?php echo $term['resetpassword']; ?></h2>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        <p class="m-0"><?php echo $term['enteryournewpassword']; ?></p>
                    </div>
                    ...
                    <form action="<?php echo base_url()?>updatePass/" method="post">
                        <div class="form-group mb-0">
                            <div class="input-group">
                                <input id="password" name="password" type="password" class="form-control form-control-lg" placeholder="<?php echo $term['password']; ?>" />
                                <input id="confirm-password" name="confirm-password" type="password" class="form-control form-control-lg" placeholder="<?php echo $term['confirm']; ?>" />

                                <input id="email" name="email" type="hidden" value="<?php print $email; ?>"/>
                                <input id="token" name="token" type="hidden" value="<?php print $token; ?>"/>

                                <span class="input-group-append">
                                <button class="btn btn-primary btn-lg" type="submit"><?php echo $term['save']; ?></button>
                            </span>
                            </div>
                        </div>
            ...
            <p class="text-center text-muted mt-3 mb-3" style="color:white !important;">&copy; <?php echo $term['copyrightallright']; ?></p>
        </div>
    </section>
