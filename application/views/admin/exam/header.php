...
<style>
	...
	@media only screen and (min-width: 768px) {
		...
		<form method="post" id="questionForm" name="questionForm" action="<?php echo base_url('admin/exam/saveQuestion');?>" enctype="multipart/form-data">
		<input type="hidden" name="exam_quiz_id" value="<?=$id?>">			
					...
					<div class="col-md-4 order-md-2">
						<?php
							...
							if($total > 0){
								...
								$question_number = $qData['position'];
						?>
                                <?php
                                if($is_only_quiz != 1) {
                                ?>
