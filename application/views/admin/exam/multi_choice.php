                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group editArea">
                            <textarea class="form-control form-control-lg" id="checkbox" name="ques_title" placeholder="Which one do you like" rows="3" ><?php echo $title; ?></textarea>
                            <input type="hidden" name="que_type" value="multi-choice">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-11">
                <div class="mt-3" autocomplete="on" id="sortable">
                    ...
                    <?php $k=0; foreach ($qData['content']['checkbox'] as $key => $value): ?>
                        <div class="form-row">
                            <?php if ($qData['content']['correctCheck'][0] == $key):?>
                                <input class="form-check-input" type="radio" name="correctCheck[]" value="<?php echo $key; ?>" <?php echo $this->session->userdata('userrole') != 'Learner'?'checked':''?> >
                            <?php else:?>
                                <input class="form-check-input" type="radio" name="correctCheck[]" value="<?php echo $key;?>">
                            <?php endif;?>
                                <input type="hidden" name="order[]" value="<?php echo $key;?>">
                            <div class="form-group col-md-9">
                                <input type="text" class="form-control" name="checkbox[]" id="checkbox1" placeholder="Option <?php echo $k+1; ?>" value="<?php echo empty($value) ? '' : $value;?>" autocomplete="off">
                            </div>
                    ...
                    <?php if(!isset($qData)): ?>
                    <div class="form-row">
                        <input class="form-check-input" type="radio" name="correctCheck[]" value="0">
                        <input type="hidden" name="order[]" value="0">
                        <div class="form-group col-md-9">
                            <input type="text" class="form-control" name="checkbox[]" placeholder="Option 1" autocomplete="off">
                        </div>
                        <div class="form-group col-md-2 pt-2 text-info ui-state-default">
                           <i class="fa fa-arrows"></i>
                        </div>
                    ...
                    <div class="form-row">
                        <input class="form-check-input" type="radio" name="correctCheck[]" value="1">
...
<!--                                <textarea class="form-control" id="feedback" name="feedback" placeholder="Add explanation shown after question is attempted." rows="2">--><?//=$qData['feedback']?><!--</textarea>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                    <div class="form-row">-->
...
$(document).ready(function(){
    ...
    $("#addMatchingRow").click(function() {
        add = add + 1;
        $.post( "<?php echo base_url('admin/exam/addMultiRow'); ?>", {count:add},function( data ) {
