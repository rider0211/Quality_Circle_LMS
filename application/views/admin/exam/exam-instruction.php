...
<!--        <link rel="stylesheet" href="--><?php //echo base_url(); ?><!--assets/css/components.css">-->
                ...
                <div class="col-lg-12" style="padding: 0px;">
                    ...
                    <section id="exam_instruction" class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="button" onClick="exam_agree()" class="btn btn-info" value="Agree">
                        </div>
                    </section>
                </div>
        </section>
    ...
    <script>
        ...
        function exam_agree(){	
			company_url = '<?php echo $company['company_url']; ?>';
            swal({
           	...
           	.then((willDelete) => {
       		if (willDelete) {				
				if(company_url == ''){ company_url = 'company/gosmartacademy.com'; }				
                exam_url = '<?php echo base_url()?>'+company_url+'/demand/show_exam_feedback/<?=$exam_id?>/<?php echo $course_id?>';
