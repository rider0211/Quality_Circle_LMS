	            ...
	            <section class="card">
	                <header class="card-header">
	                    <div class="card-actions">
	                        <a class="modal-with-form add-user" href="<?= base_url()?>admin/settings/certificateview">
...
<script>
    ...
    function deleteCategory(id) {
        ...
        (new PNotify({
            ...
            $.ajax({
                url: $('#base_url').val()+'admin/settings/certificatedelete',
                type: 'POST',
                data: {id:id},
    ...
    jQuery(document).ready(function() {
        ...
        $table.dataTable({
            ...
            "ajax": {
                "type": "POST",
                "async": true,
                "url":$('#base_url').val() +"admin/settings/getcertificate",
                "data": {},
                "dataSrc": "data",
                "dataType": "json",
                "cache":    false,
...
//            },
                ...
                "targets": [1],
                "createdCell": function (td, cellData, rowData, row, col) {
                    $(td).html('<a href="<?=base_url()?>admin/settings/certificateview/'+cellData+'"><i class="fas fa-pencil-alt"></i></a><span class="w-20"></span><a href="javascript:deleteCategory('+cellData+')" class="delete-row"><i class="far fa-trash-alt"></i></a>');
                }
            }],
            "columns": [
