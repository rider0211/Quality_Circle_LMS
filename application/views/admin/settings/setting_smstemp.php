<section role="main" class="content-body">
	...
	<div class="row">
    	...
    	<div class="inner-body">
			<div class="col-lg-12">
                <form id="add-form" action="<?=base_url()?>admin/settings/savesmstemp" method="POST" novalidate="novalidate" enctype="multipart/form-data"">
                    <section class="card">
...
<script>
    ...
    $(document).on('click', '.modal-add-confirm', function (e) {
        ...
        if(frm.valid()) {
            ...
            $('#add-form').submit();
            //<?=base_url()?>admin/settings/savetheme
