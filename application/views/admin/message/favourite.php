                        ...
                        <div class="nano has-scrollbar hovered">
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                ...
                                <div class="inner-menu-content">
                                    <a href="<?php echo base_url('company/message/compose');?>" class="btn btn-block btn-primary btn-md pt-2 pb-2 text-3">
                                    ...
                                    <ul class="list-unstyled mt-3 pt-3">
                                        <li>
                                            <a href="<?php echo base_url('company/message');?>" class="menu-item">Inbox <span class="badge badge-primary font-weight-normal float-right">43</span></a>
                                        </li>

                                        <li>
                                            <a href="<?php echo base_url('company/message/sent');?>" class="menu-item">Sent</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('company/message/favourite');?>" class="menu-item active">Favourites</a>
                                        </li>
                                        <li>
