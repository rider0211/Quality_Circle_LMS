                            ...
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                ...
                                <div class="inner-menu-content">
                                    ...
                                    <ul class="list-unstyled mt-3 pt-3">
                                        <li>
                                            <a href="<?php echo base_url('admin/message');?>" class="menu-item active"> <i class="fa fa-inbox" style="margin-right: 9px;"></i><?php echo $term['inbox']; ?> <span class="badge badge-primary font-weight-normal float-right"><?php echo $new_ms_nums; ?></span></a>
                                        </li>
                                    ...
                                    <ul id="" class="list-unstyled">
                                        ...
                                        <?php foreach($message_receive_list as $item){ ?>
                                            <li class="<?php if($item['rd_status'] == 0) echo "unread";?>">
                                                <a href="<?php echo base_url('admin/message/details/1/'.$item['message_id']); ?>">
                                                    ...
                                                    <div class="col-sender">
                                                        ...
                                                        <?php } else{ ?>
                                                            <p class="m-0 ib"><?php echo $item['company_name'] ; ?></p>
                                                        <?php }  ?>
                                                    </div>
                                                    <div class="col-mail">
