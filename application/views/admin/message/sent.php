                            ...
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                ...
                                <div class="inner-menu-content">
                                    ...
                                    <ul class="list-unstyled mt-3 pt-3">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('admin/message/sent');?>" class="menu-item active"><i class="fa fa-paper-plane" style="margin-right: 9px;"></i><?php echo $term['sent']; ?></a>
                                        </li>
<!--                                        <li>
                                ...
                                <div class="nano-content" tabindex="0" style="right: -17px;">
                                    <ul id="" class="list-unstyled">
                                        ...
                                        <?php foreach($message_receive_list as $item){ ?>
                                            <li>
                                                <a href="<?php echo base_url('admin/message/details/0/'.$item['message_id']); ?>">
                                                    <div class="col-sender">
                                                        <?php if($item['user_type'] != 'Admin'){ ?>
                                                            <p class="m-0 ib">To <?php echo $item['first_name'].' '.$item['last_name'] ; ?></p>
                                                        <?php } else{ ?>
                                                            <p class="m-0 ib">To <?php echo $item['company_name'] ; ?></p>
                                                        <?php }  ?>
                                                    </div>
                                                    <div class="col-mail">
