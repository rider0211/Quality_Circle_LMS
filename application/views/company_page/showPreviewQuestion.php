...
<head>
    ...
    <body id="iframe_body" style="height: auto;">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-3" style="width: 20%;float: left;"><h5>Time Status : </h5></div>
                        <div class="col-md-9"><h5 id="show_time" style="color: #21E321;"></h5></div>
                    </div>
                </div>
                <div class="progress">
        ...
        <main role="main" class="container">
            <div class="container">
                        ...
                        <?php
                            ...
                            switch ($question['type']) {
                                ...
                                case 'fill-blank':
                                    ...
                                    break;
                                case 'essay':
                                    $this->load->view('admin/exam/subviews/essay_preview',array("answer"=>$quiz_answer['essay']));
                                    break;
                                case 'matching':
                                    $this->load->view(
                ...
                if($show_button):
                    if($next == $end+2):?>
                        <?php if ($exam_type == 'Manual' && $before != 0):?>
                            <button type="button" class="btn btn-primary mt-5 nextquestion" data-submit="0" data-url="<?php echo base_url($company['company_url'])?>/demand/showPreviewQuestion/<?php echo $question['exam_id'];?>?next=<?=$before?>">
                    ...
                    <?php else: ?>
                        ...
                        <?php endif;?>
                        <button type="button" class="btn btn-primary mt-5 nextquestion" data-submit="0" data-url="<?php echo base_url($company['company_url'])?>/demand/showPreviewQuestion/<?php echo $question['exam_id'];?>?next=<?=$next?>">
    ...
    <script>
        ...
        function myTimer() {
            ...
            show_time = "";
            if (time_taken/3600 > 10){
                show_time = show_time+""+parseInt(time_taken/3600)+" :";
                $("#show_time").html(show_time);
            }else if (time_taken/3600 >= 1){
                show_time = show_time+"0"+parseInt(time_taken/3600)+" :";
                $("#show_time").html(show_time);
            }else{
                show_time = show_time+"00 : ";
                $("#show_time").html(show_time);
            }
            if (time_taken%3600/60 >= 10){
                show_time = show_time+""+parseInt(time_taken%3600/60)+" :";
                $("#show_time").html(show_time);
            }else if (time_taken%3600/60 >= 1){
                show_time = show_time+" 0"+parseInt(time_taken%3600/60)+" :";
                $("#show_time").html(show_time);
            }else{
                show_time = show_time+"00 : ";
                $("#show_time").html(show_time);
