        ...
        <div class="col-lg-12">
            <section class="card">
                <header class="card-header">
                    <h2 class="card-title"><?php echo $term['topichistory']; ?></h2>
                </header>
                <div class="card-body">
                    <table class="table table-responsive-md table-hover mb-0" id="datatable_training_history" >
                    </table>
                    <form id="form_topic_history" action="<?php echo base_url(); ?>fasi/traininghistory/viewlesson" method="POST">
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            var tbdata = $history_table.dataTable({
                ...
                "columns": [
                    { "title": "<?php echo $term['company']; ?>", "data": "company_name", "class": "text-left", "width":60 },
                    ...
                    { "title": "<?php echo $term['title']; ?>", "data": "training_title", "class": "text-left", "width":"*" },
                    { "title": "<?php echo $term['duration']; ?>", "data": "duration", "class": "text-center", "width":100 },
                    { "title": "<?php echo $term['startdate']; ?>", "data": "start_date", "class": "text-left", "width":"100"},
                    { "title": "<?php echo $term['enddate']; ?>", "data": "end_date", "class": "text-left", "width":"100" },
                    { "title": "<?php echo $term['action']; ?>", "data": "log_id", "class": "text-center", "width":60 },
                ],
                "lengthMenu": [
                    [5, 10, 20, 50, 150, -1],
