<section role="main" class="content-body">
        ...
        <div class="col-lg-12">
            <section class="card">
                <header class="card-header">
                    <h2 class="card-title"><?php echo $term['sccexamhistory']; ?></h2>
                </header>
                <div class="card-body">
    ...
    <div id="modalAnim" style="max-width: 800px;" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
        <section class="card">
            <header class="card-header">
                <h2 class="card-title"><?php echo $term['employeesignature']; ?></h2>
            </header>
            <div class="card-body">
            ...
            <footer class="card-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button class="btn btn-default modal-dismiss"><?php echo $term['close']; ?></button>
                    </div>
                </div>
            </footer>
        </section>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            var tbdata = $history_table.dataTable({
                ...
                "columns": [
                    { "title": "<?php echo $term['company']; ?>", "data": "company_name", "class": "text-left", "width":100 },
                    ...
                    { "title": "<?php echo $term['category']; ?>", "data": "exam_category_name", "class": "text-left", "width":100, "visible": true },
                    { "title": "<?php echo $term['title']; ?>", "data": "exam_title", "class": "text-left", "width":"*" },
                    { "title": "<?php echo $term['quizcount']; ?>", "data": "quiz_count", "class": "text-right", "width":60 },
                    { "title": "<?php echo $term['price']; ?>", "data": "exam_price", "class": "text-right", "width":100 },
                    { "title": "<?php echo $term['repeatdays']; ?>", "data": "repeat_days", "class": "text-right", "width":100},
                    { "title": "<?php echo $term['startdate']; ?>", "data": "exam_start_at", "class": "text-left", "width":100 },
                    { "title": "<?php echo $term['enddate']; ?>", "data": "exam_end_at", "class": "text-left", "width":100 },
                    { "title": "<?php echo $term['status']; ?>", "data": "exam_status", "class": "text-center", "width":60 },
                    { "title": "<?php echo $term['action']; ?>", "data": "id", "class": "text-left", "width":60 },
                ],
                "lengthMenu": [
                    [5, 10, 20, 50, 150, -1],
