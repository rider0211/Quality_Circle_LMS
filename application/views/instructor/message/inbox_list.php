                        ...
                        <div class="nano has-scrollbar hovered">
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                ...
                                <div class="inner-menu-content">
                                    <a href="<?php echo base_url('instructor/message/compose');?>" class="btn btn-block btn-primary btn-md pt-2 pb-2 text-3">
                                    ...
                                    <ul class="list-unstyled mt-3 pt-3">
                                        <li>
                                            <a href="<?php echo base_url('instructor/message');?>" class="menu-item active"> <i class="fa fa-inbox" style="margin-right: 9px;"></i><?php echo $term['inbox']; ?> <span class="badge badge-primary font-weight-normal float-right"><?php echo $new_ms_nums; ?></span></a>
                                        </li>

                                        <li>
                                            <a href="<?php echo base_url('instructor/message/sent');?>" class="menu-item"><i class="fa fa-paper-plane" style="margin-right: 9px;"></i><?php echo $term['sent']; ?></a>
                                        </li>
<!--                                        <li>
                                ...
                                <div class="nano-content" tabindex="0" style="right: -17px;">
                                    <ul id="" class="list-unstyled">
                                        ...
                                        <?php foreach($message_receive_list as $item){ ?>
                                            <li class="<?php if($item['rd_status'] == 0) echo "unread";?>">
                                                <a href="<?php echo base_url('instructor/message/details/1/'.$item['message_id']); ?>">
                                                    <?php if($item['rd_status'] == 0) {?>
                                                    <i class="mail-label" style="border-color: #EA4C89"></i>
                                                    <?php } ?>
                                                    <div class="col-sender">
                                                        <p class="m-0 ib"><?php echo $item['first_name'].' '.$item['last_name'] ; ?></p>
                                                    </div>
                                                    <div class="col-mail">
