                            ...
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                ...
                                <div class="inner-menu-content">
                                    ...
                                    <ul class="list-unstyled mt-3 pt-3">
                                        <li>
                                            <a href="<?php echo base_url('instructor/message');?>" class="menu-item"> <i class="fa fa-inbox" style="margin-right: 9px;"></i><?php echo $term['inbox']; ?> <span class="badge badge-primary font-weight-normal float-right"><?php echo $new_ms_nums; ?></span></a>
                                        </li>
...
<script>
    ...
    function sendMsg(){
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>/instructor/message/send_message',
            type: 'POST',
            data: {
            ...
            success: function (data, status, xhr) {
                ...
                setTimeout(function(){
                    window.location.href="<?php echo base_url(); ?>/instructor/message/sent";
                }, 2500);
            },
            error: function(){
                $("#sendBtn").trigger('loading-overlay:hide');
                ...
                setTimeout(function(){
                    window.location.href="<?php echo base_url(); ?>/instructor/message/compose";
                }, 2500);
            }
        });
    }
