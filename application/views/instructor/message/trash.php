                            ...
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                ...
                                <div class="inner-menu-content">
                                    ...
                                    <ul class="list-unstyled mt-3 pt-3">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('fasi/message/favourite');?>" class="menu-item">Favourites</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('fasi/message/trash');?>" class="menu-item active">Trash</a>
                                        </li>
                                    </ul>
