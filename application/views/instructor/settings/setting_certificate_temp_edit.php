                    ...
                    <section class="card">
                        <header class="card-header">
                            <div class="card-actions">
                                ...
                                <a class="btn btn-default" href="<?= base_url()?>instructor/settings/certificate"><i class="fas fa-table"></i> Certificate List</a>
                            </div>
    ...
    $(document).on('click', '.modal-add-confirm', function (e) {
        ...
        if(frm.valid()) {
            ...
            if($('#add-form .modal-add-confirm').html() == 'Add') {
                $.ajax({
                    url: $('#base_url').val()+'instructor/settings/certificateadd',
                    type: 'POST',
                    data: formData,
                    processData:false,
                    contentType: false,
                    success: function (data, status, xhr) {
                        ...
                        document.location = '<?php echo base_url();?>instructor/settings/certificate'; 
                    },
                    error: function(){
                        new PNotify({
                ...
                $.ajax({
                    url: $('#base_url').val()+'instructor/settings/certificatechange',
                    type: 'POST',
                    data: formData,
                    processData:false,
                    contentType: false,
...
//        });
    ...
    function  save_btn() {
        ...
        $.ajax({
            url: '<?=site_url()?>instructor/settings/certificateadd',
            type: 'POST',
            //dataType: 'json',
            data: {
                id: $('#id').val(),
    ...
    var  _emailBuilder=  $('.editor').emailBuilder({
        ...
        blankPageHtmlUrl: '<?=base_url()?>instructor/email_template/template-blank-page.html',
        loadPageHtmlUrl: '<?=base_url()?>instructor/email_template/template-load-page.html',
