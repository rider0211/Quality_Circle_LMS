...
<script>
	...
	jQuery(document).ready(function() {
		$("#select_lang").themePluginSelect2({
			...
			ajax: {
				"type": "POST",
				url: "<?php echo base_url();?>instructor/settings/get_trans_seletable_lang_list",
				dataType: 'json',
		...
		$table.dataTable({
			...
			"ajax": {
				...
				url: "<?php echo base_url();?>instructor/settings/get_trans_selected_lang_list",
				"data": '',
				"dataSrc": "data",
				"dataType": "json",
				"cache":    false,
	...
	function activate(id, newvalue){
		$.post({
			url: "<?php echo base_url();?>instructor/settings/update_trans_activate",
			data:{
				'id' : id,
				'value' : newvalue,
			},
