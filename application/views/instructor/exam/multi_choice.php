                    ...
                    <?php $k=0; foreach ($qData['content']['checkbox'] as $key => $value): ?>
                        <div class="form-row">
                            <?php if ($qData['content']['correctCheck'][0] == $key):?>
                                <input class="form-check-input" type="radio" name="correctCheck[]" value="<?php echo $key; ?>" checked>
                            <?php else:?>
...
$(document).ready(function(){
    ...
    $("#addMatchingRow").click(function() {
        add = add + 1;
        $.post( "<?php echo base_url('instructor/exam/addMultiRow'); ?>", {count:add},function( data ) {
