                        ...
                        <div class="form-row">
                            <?php for ($i=0;$i<count($qData['content']['correctCheck']);$i++){?>
                                <?php if ($qData['content']['correctCheck'][$i] == $key):?>
                                    <?php $temp_count++;?>
                                    <input class="form-check-input" type="checkbox" name="correctCheck[]" value="<?php echo $k; ?>" checked>
                                <?php endif;?>
                            <?php }?>
                            <?php if ($temp_count == 0):?>
...
$(document).ready(function(){
    ...
    $("#addMatchingRow").click(function() {
        add = add + 1;
        $.post( "<?php echo base_url('instructor/exam/addCheckboxRow'); ?>", {count:add},function( data ) {
