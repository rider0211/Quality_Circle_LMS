			...
			<section class="card">
				<header class="card-header">
					<div class="card-actions">	
						<a class="btn btn-default" id="btn_list" href="<?php echo base_url(); ?>fasi/examassign"><i class="fas fa-table"></i> <?php echo $term['assignlist']; ?></a>
					</div>

					<h2 class="card-title"><?php echo $term['examassign']; ?> </h2>
				</header>
				<div class="card-body">
					<div class="form-group row">
						<label class="col-sm-1 control-label text-sm-right pt-2"> <?php echo $term['type']; ?>: <span class="required">*</span></label>
						<div class="col-sm-3">
						...
						<label class="col-sm-1 control-label text-sm-right pt-2"> <?php echo $term['employees']; ?> <span class="required">*</span></label>
						<div class="col-sm-3">
					...
					<div class="form-group row">
						<div class="col-lg-6">
							<fieldset>
								<legend><?php echo $term['selectableexams']; ?></legend>
								<div>
						...
						<div class="col-lg-6">
							<fieldset>
								<legend><?php echo $term['selectedexams']; ?></legend>
									<div class="row" style="margin-bottom: 10px;">
    									<label class="col-lg-4 control-label text-sm-right pt-2"> <?php echo $term['category']; ?> </label>
	    								<div class="col-lg-6 input-group">
