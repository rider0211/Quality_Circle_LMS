		...
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="#" class="logo">
						<img src="<?php echo base_url(); ?>assets/img/logo.png" width="75" height="35" alt="LMS" />
					</a>
			...
			<div class="inner-wrapper">
				                ...
				                <ul class="nav nav-main">
				                    ...
				                    <li class="nav-parent">
				                        ...
				                        <ul class="nav nav-children">
				                            <li>
				                                <a class="nav-link" href="#">
				                                    <i class="fas "></i> Admin Users
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="#">
				                                    <i class="fas "></i> Fasi Users
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="#">
				                                    <i class="fas "></i> Company Users
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="#">
				                                    <i class="fas "></i> Employee Users
				                                </a>
				                            </li>
				                        </ul>
				                    </li>
				                        ...
				                        <ul class="nav nav-children">
				                            <li>
				                                <a class="nav-link" href="/category">
				                                    <i class="fas "></i> Category
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="/lesson">
				                                    <i class="fas "></i> Lessons
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="#">
				                                    <i class="fas "></i> Topics
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="#">
				                                    <i class="fas "></i> Assign
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="#">
				                    ...
				                    <li class="nav-parent">
				                        ...
				                        <ul class="nav nav-children">
				                            <li>
				                                <a class="nav-link" href="#">
				                                    <i class="fas "></i> Quizzes
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="#">
				                                    <i class="fas "></i> ExamList
				                                </a>
				                            </li>
				                            <li>
				                                <a class="nav-link" href="#">
				...
				<section role="main" class="content-body">
										...
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Export Certifications</h4>
														<div class="info">
									...
									<section class="card card-featured-left card-featured-tertiary mb-3">
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">New Employees</h4>
														<div class="info">
															<strong class="amount">38</strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="#">(Accept)</a>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="col-lg-6 mb-4 mb-lg-0">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Examine Status</h2>
						...
						<div class="col-xl-6">
							<section class="card">
								<header class="card-header">
									...
									<h2 class="card-title">Training Stats</h2>
								</header>
								<div class="card-body">
					...
					">
			            ...
			            <strong>Copyright © 2018 <a href="http://localhost:10180/">admin.com</a>.</strong> All rights reserved.
			        </footer>
				</section>
