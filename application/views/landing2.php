...
.headerHero {
    background-image: url(https://dev.gosmartacademy.com/assets/images/sky-banner.png) !important;
}
body{
...
<section class="Join-today" data-aos="slide-up" data-aos-duration="3000">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="main-join-today">
					<ul class="join-ul">
						...
						<li><button class="btn free-b" value="button"><a href="https://dev.gosmartacademy.com/pricing">Join Now</a></button></li>
...
<div class="custom-block">
	<div class="container">
		<div class="row subscrib-flex">
            ...
            <div class="col-lg-12" data-aos="zoom-in" data-aos-duration="3000">
...
<section class="sectionBox">
    <div class="container">
        ...
        <?php foreach($virtualCourses as $course): ?>
            ...
            <div class="col-md-4 col-sm-4 col-xs-6 col-full" data-aos="flip-left" data-aos-duration="3000">
                <div class="courseBox">
                    <div class="courseImg">
            ...
            <?php endforeach; ?>
             ...
             <?php foreach ($trainCourses as $course):?>
                <div class="col-md-4 col-sm-6 col-xs-6 col-full" data-aos="flip-left" data-aos-duration="3000">
                    <div class="courseBox">
                        <div class="courseImg">
...
<section class="joining-sec">
	<div class="container">
		<div class="row">
			<div class="col-md-4" data-aos="slide-up" data-aos-duration="3000">
...
<section class="play-video">
	<p class="watch-vd" onclick="openModal();currentSlide(1)" data-aos="zoom-in" data-aos-duration="3000">Watch the Video <img class="play-vd" src="assets/images/play-button.png"></p>
</section>

<section class="platform">
	<div class="container">
		<div class="row row-center">
			<div class="col-md-6" data-aos="slide-up" data-aos-duration="3000">
				<div class="platform-common">
					<!-- <img class="plat-im" src="assets/images/.png"> -->
				</div>
			</div>
			<div class="col-md-6 center-pl" data-aos="slide-up" data-aos-duration="3000">
				<div class="platform-common1">
					...
					<button class="btn free-b" value="button"><a href="https://dev.gosmartacademy.com/pricing">Join Now</a></button>
				</div>
			</div>
		</div>
	</div>
