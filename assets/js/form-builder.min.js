 ...
 */
var _Mathfloor = Math.floor, _Mathmax = Math.max;
!function (A) {
    function e(r) {
    ...
    111: function (A) {
        ...
        function o(A) {
            for (var e = [], t = {}, r = 0; r < A.length; r++) {
                var o = A[r], i = o[0], n = o[1], a = o[2], l = o[3], s = {css: n, media: a, sourceMap: l};
        ...
        function i(A, e) {
            ...
            var r = B[B.length - 1];
            if ("top" === A.insertAt)r ? r.nextSibling ? t.insertBefore(e, r.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild), B.push(e); else {
        ...
        function u(A, e, t, r) {
            var o = t ? "" : r.css;
            if (A.styleSheet)A.styleSheet.cssText = I(e, o); else {
                var i = document.createTextNode(o), n = A.childNodes;
        ...
        function f(A, e) {
            ...
            if (r && A.setAttribute("media", r), A.styleSheet)A.styleSheet.cssText = t; else {
        ...
        function g(A, e, t) {
            ...
            var n = new Blob([r], {type: "text/css"}), a = A.href;
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var n = t(51), a = t(115), l = t(19), s = r(l), c = t(53), u = r(c), f = t(29), g = r(f), d = t(52), p = t(6), w = r(p), m = t(35), b = r(m), B = s.default.markup, h = function () {
            function A(e, t) {
            ...
            return A.prototype.startMoving = function (A, e) {
                ...
                var t = this, r = d.config.opts, o = t.d.stage, i = o.childNodes.length - 1, n = [];
                ...
                var e = {type: A.attr("type")}, t = $(".fld-subtype", A).val();
                return t !== e.type && (e.subtype = t), e
            }, A.prototype.fieldOptionData = function (A) {
                var e = [], t = $(".sortable-options li", A);
                return t.each(function (A) {
                    var r = $(t[A]), o = $(".option-selected", r).is(":checked"), i = {
                ...
                var e = this.prepData(A), t = ["<form-template>\n\t<fields>"];
                return s.default.forEach(e, function (A, e) {
                    var r = null, o = n.optionFieldsRegEx;
                    if (e.type.match(o)) {
                        for (var i = e.values, a = [], l = 0; l < i.length; l++) {
                            var s = i[l], c = B("option", s.label, s).outerHTML;
                            a.push("\n\t\t\t" + c)
                        }
                ...
                var e = A.lastIndexOf("-"), t = parseInt(A.substring(e + 1)) + 1;
                ...
                if (-1 === r.indexOf("input-control")) {
                    ...
                    var g = b.default.lookup(c.type), d = g ? g.class : w.default.getClass(c.type, c.subtype);
                ...
                var e = function (A, e) {
                    var t = e.field.getBoundingClientRect(), r = A.clientX - t.left - 21, o = A.clientY - t.top - e.tt.offsetHeight - 12;
                    e.tt.style.transform = "translate(" + r + "px, " + o + "px)"
                }, t = A.querySelectorAll(".disabled-field");
                s.default.forEach(t, function (A) {
                    var r = t[A], o = g.default.get("fieldNonEditable");
                    if (o) {
                ...
                if (t) {
                    var r = void 0, o = e.type, i = e.style, n = t.value.split(" "), a = {
                        button: "btn",
                        submit: "btn"
                    }[o];
                    if (a) {
                ...
                var A = this, e = s.default.markup("div", null, {className: "form-builder-overlay"});
                return document.body.appendChild(e), e.classList.add("visible"), e.onclick = function () {
                    A.closeConfirm(e)
                }, e
            }, A.prototype.confirm = function (A, e) {
                var t = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], r = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : "", o = this, i = g.default.current, n = o.showOverlay(), a = B("button", i.yes, {className: "yes btn btn-success btn-sm"}), l = B("button", i.no, {className: "no btn btn-danger btn-sm"});
                l.onclick = function () {
                    o.closeConfirm(n)
                }, a.onclick = function () {
                    e(), o.closeConfirm(n)
                ...
                if (t)c.classList.add("positioned"); else {
                ...
                var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], t = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : "", r = this, o = document.documentElement.clientWidth, i = document.documentElement.clientHeight;
                ...
                var e = this, t = A.target.id.match(/frmb-\d{13}/)[0], r = document.getElementById(t), o = g.default.current, i = $("li.form-field", r), n = A.target.getBoundingClientRect(), a = document.body.getBoundingClientRect(), l = {
                ...
                var e = this, t = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1], r = g.default.current, o = d.config.opts, i = A.querySelectorAll("li.form-field"), a = [];
                ...
                var A = this, e = $("> li.editing", A.d.stage), t = $(".toggle-form", A.d.stage), r = $(".frm-holder", e);
                t.removeClass("open"), e.removeClass("editing"), $(".prev-holder", e).show(), r.hide()
            }, A.prototype.toggleEdit = function (A) {
                var e = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1], t = document.getElementById(A), r = $(".toggle-form", t);
                if (r.length) {
                    var o = $(".frm-holder", t);
                ...
                var A = this.d, e = $(A.controls).parent(), t = $(A.stage).parent(), r = e.width(), o = A.controls.getBoundingClientRect();
                $(window).scroll(function (i) {
                    var n = $(i.target).scrollTop(), a = {
                        top: 5,
                        bottom: "auto",
                        right: "auto",
                        left: o.left
                    ...
                    if (n > t.offset().top) {
                        var s = Object.assign({
                            position: "fixed",
                            width: r
                        }, l), c = e.offset(), u = t.offset(), f = c.top + e.height(), g = u.top + t.height(), p = f === g && c.top > n;
                ...
                var A = this.data, e = s.default.escapeHtml(A.formData), t = B("code", e, {className: "formData-" + d.config.opts.dataType});
                this.dialog(B("pre", t), null, "data-dialog")
            }, A.prototype.removeField = function (A) {
                var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 250, t = !1, r = this, o = this.d.stage, i = o.getElementsByClassName("form-field");
                ...
                var a = document.getElementById(A), l = $(a);
                ...
                var e = A.label, t = A.events, r = o(A, ["label", "events"]), i = this.data;
                ...
                var r = w.default.getRegisteredSubtypes(), o = {};
                for (var i in r)if (r.hasOwnProperty(i)) {
                    for (var n = [], a = r[i], l = Array.isArray(a), s = 0, a = l ? a : a[Symbol.iterator](); ;) {
                        ...
                        var u = c, f = w.default.getClass(i, u);
                ...
                var A = this.d, e = this.data;
                A.stage = B("ul", null, {
                    id: e.formID,
                    className: "frmb"
                }), A.controls = B("ul", null, {id: e.formID + "-control-box", className: "frmb-control"})
            }, A.prototype.processOptions = function (A) {
                var e = this, t = A.actionButtons, r = A.replaceFields, i = o(A, ["actionButtons", "replaceFields"]);
                return t = [{
                    type: "button",
                    id: "clear",
                    className: "clear-all btn btn-danger",
                    events: {click: e.confirmRemoveAll.bind(e)}
                }, {
                    type: "button",
                    label: "viewJSON",
                    id: "data",
                    className: "btn btn-default get-data",
                    events: {click: e.showData.bind(e)}
                }, {
                ...
                var A = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "js", e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], t = this;
                return {
                    js: function () {
        ...
        var r = t(359);
        "string" == typeof r && (r = [[A.i, r, ""]]), t(113)(r, {attrs: {class: "formBuilder-injected-style"}}), r.locals && (A.exports = r.locals)
    }, 153: function (A, e, t) {
        "use strict";
        function r(A) {
            return A && A.__esModule ? A : {default: A}
        ...
        t(61), t(151);
        var n = t(51), a = r(n), l = t(115), s = t(29), c = r(s), u = t(19), f = r(u), g = t(53), d = r(g), p = t(60), w = r(p), m = t(149), b = r(m), B = t(52), h = t(6), I = r(h);
        t(59);
        var E = t(35), M = r(E), y = (new Date).getTime(), Q = function A(e, t) {
            function r(A, e) {
                var t = [];
                for (var r in A)if (A.hasOwnProperty(r)) {
                    var i = p[r], n = A[r], a = n.value;
            ...
            var u = this, g = this, p = c.default.current, m = "frmb-" + y++, h = new l.Data(m), E = new a.default(m);
            e.layout || (e.layout = w.default);
            var Q = new e.layout(e.layoutTemplates, !0);
            I.default.controlConfig = e.controlConfig || {};
            var C = new b.default(m, Q), D = f.default.markup, x = e;
            ...
            var F = I.default.getRegistered(), Y = M.default.getRegistered();
            Y && $.merge(F, Y), e.sortableControls && E.controls.classList.add("sort-enabled");
            for (var U = $(E.controls), T = [], j = {}, L = 0; L < F.length; L++) {
                var R = F[L], G = M.default.lookup(R), S = void 0;
                if (G)S = G.class; else if (G = {}, !(S = I.default.getClass(R)) || !S.active(R))continue;
                var k = G.icon || S.icon(R), z = G.label || S.label(R), O = k ? "" : G.iconClassName || "icon-" + R.replace(/-[\d]{4}$/, "");
            ...
            e.inputSets.length && e.inputSets.forEach(function (A, e) {
                var t = A.name, r = A.label, o = A.icon;
            ...
            var J = function (A) {
                if (A[0].classList.contains("input-set-control")) {
                    var t = [], r = e.inputSets.find(function (e) {
            ...
            var H = $(E.editorWrap), V = D("div", E.controls, {
                id: h.formID + "-cb-wrap",
            ...
            var _ = function () {
                ...
                if (A instanceof jQuery)if (t.type = A[0].dataset.type, t.type) {
                    var r = M.default.lookup(t.type);
                    if (r)t = Object.assign({}, r); else {
                ...
                var e = A.type, t = A.values, r = A.name, o = [D("a", p.addOption, {className: "add add-opt"})], i = [D("label", p.selectOptions, {className: "false-label"})], n = A.multiple || "checkbox-group" === e, a = function (A) {
                ...
                var c = D("div", o, {className: "option-actions"}), u = D("ol", t.map(function (A) {
                    return fA(r, A, n)
                }), {className: "sortable-options"}), g = D("div", [u, c], {className: "sortable-options-wrap"});
                return i.push(g), D("div", i, {className: "form-group field-options"}).outerHTML
            }, rA = function (A) {
                var e = ["required", "label", "description", "placeholder", "className", "name", "access", "value"], t = ["header", "paragraph", "file", "autocomplete"].concat(E.optionFields), r = !f.default.inArray(A, t), o = {
                ...
                var t = A.type, o = [], i = rA(t), n = {
                    required: function () {
                        ...
                        var t = A.role ? 'style="display:block"' : "", r = ['<div class="available-roles" ' + t + ">"];
                        for (a in e.roles)if (e.roles.hasOwnProperty(a)) {
                            var o = "fld-" + h.lastID + "-roles-" + a, i = {
                                type: "checkbox",
                                name: "roles[]",
                                value: a,
                                id: o,
                ...
                }, a = void 0, l = void 0 === A.role ? [] : A.role.split(",");
                ...
                e[A] && (o.checked = !0);
                var i = [], n = [D("input", null, o).outerHTML];
                ...
                var t = e[A], r = p[A] || A, o = p["placeholder." + A], i = {
                    type: "number",
                    value: t,
                    name: A,
                    min: "0",
                ...
                var r = t.map(function (t, r) {
                    ...
                    name: A,
                    className: "fld-" + A + " form-control"
                }, i = p[A] || f.default.capitalize(A), n = D("label", i, {for: o.id}), a = D("select", r, o), l = D("div", a, {className: "input-wrap"});
                ...
                if (![].some(function (A) {
                    ...
                    var l = '<div class="input-wrap">' + i + "</div>", s = "block";
                ...
                var t = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1], r = A.type || "text", o = A.label || p[r] || p.label, i = e.disabledFieldButtons[r] || A.disabledFieldButtons, n = [D("a", null, {
                    type: "remove",
                    id: "del_" + h.lastID,
                ...
                var a = [D("div", n, {className: "field-actions"}), D("label", f.default.parsedHtml(o), {className: "field-label"}), D("span", " *", {
                ...
                var c = D("li", a, {class: r + "-field form-field", type: r, id: h.lastID}), u = $(c);
                u.data("fieldData", {attrs: A}), void 0 === C.stopIndex ? N.append(u) : $("> li", E.stage).eq(C.stopIndex).before(u), $(".sortable-options", u).sortable({
                    update: function () {
                ...
                var r = {selected: t ? "checkbox" : "radio"}, o = ["value", "label", "selected"], i = [];
                e = Object.assign({selected: !1, label: "", value: ""}, e);
                for (var n, a = o.length - 1; 0 <= a; a--)if (n = o[a], e.hasOwnProperty(n)) {
                ...
                var t = A.attr("id"), r = A.attr("type"), o = (new Date).getTime(), i = r + "-" + o, n = A.clone();
                return $(".fld-name", n).val(i), n.find("[id]").each(function (A, e) {
                    e.id = e.id.replace(t, h.lastID)
                }), n.find("[for]").each(function (A, e) {
                    var r = e.getAttribute("for"), o = r.replace(t, h.lastID);
            ...
            if (N.on("click touchstart", ".remove", function (A) {
                    var t = $(A.target).parents(".form-field:eq(0)"), r = t[0], o = r.getAttribute("type"), i = $(A.target.parentElement);
                    ...
                    if ("checkbox" === e.attr("type"))e.trigger("click"); else {
                        e.focus();
                        var t = e.val();
                        e.val(t)
                    }
                    ...
                    var e = $(A.target).parents(".form-field:eq(0)"), t = $(".tooltip-element", e), r = $(A.target).val();
                    ...
                    var e = A.target.checked ? "checkbox" : "radio", t = $(".option-selected", $(A.target).closest(".form-elements"));
                    return t.each(function (A) {
                        return t[A].type = e
                    }), e
                    ...
                    A.preventDefault();
                    var e = $(A.target).parent().parent("li"), t = gA(e);
                    t.insertAfter(e), C.updatePreview(t), C.save.call(C)
                }), N.on("click touchstart", ".delete-confirm", function (A) {
                    A.preventDefault();
                    var t = A.target.getBoundingClientRect(), r = document.body.getBoundingClientRect(), o = {
                        pageX: t.left + t.width / 2,
                        pageY: t.top - r.top - 12
                    }, i = $(A.target).parents(".form-field:eq(0)").attr("id"), n = $(document.getElementById(i));
                    if (document.addEventListener("modalClosed", function () {
                            n.removeClass("deleting")
                        }, !1), e.fieldRemoveWarn) {
                        var a = f.default.markup("h3", p.warning), l = f.default.markup("p", p.fieldRemoveWarning);
                    ...
                    var e = $(A.target), t = e.val(), r = e.parent().prev(".btn-style");
                    ...
                    var e = $(A.target).closest(".form-field").find(".available-roles"), t = $(A.target);
                    e.slideToggle(250, function () {
                        t.is(":checked") || $("input[type=checkbox]", e).removeAttr("checked")
                    })
                }), N.on("click", ".add-opt", function (A) {
                    A.preventDefault();
                    var e = $(A.target).closest(".field-options"), t = $('[name="multiple"]', e), r = $(".option-selected:eq(0)", e), o = !1;
        ...
        !function (A) {
            A.fn.formBuilder = function (e) {
                e || (e = {});
                var t = this, r = A.extend({}, B.defaultOptions, e, !0), i = r.i18n, n = o(r, ["i18n"]);
                B.config.opts = n;
                var a = A.extend({}, B.defaultI18n, i, !0), l = {
                    actions: {
                        getData: null,
                        setData: null,
                        save: null,
        ...
        window.fbLoaded = {js: [], css: []}, window.fbEditors = {quill: {}, tinymce: {}}, o.inArray = function (A, e) {
            ...
            var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "", r = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}, i = o.contentType(e), n = r.events, a = t(r, ["events"]), l = document.createElement(A), s = {
                string: function (A) {
                    l.innerHTML += A
                }, object: function (A) {
                    var e = A.tag, r = A.content, i = t(A, ["tag", "content"]);
            ...
            var e = new window.DOMParser, t = e.parseFromString(A, "text/xml"), r = [];
            if (t)for (var i = t.getElementsByTagName("field"), n = 0; n < i.length; n++) {
                var a = o.parseAttrs(i[n]), l = i[n].getElementsByTagName("option");
            ...
            var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "js", t = window.fbLoaded[e];
            ...
            for (var t = e.replace(".", ""); (A = A.parentElement) && !A.classList.contains(t););
            return A
        }, o.noop = function () {
            return null
        }, o.debounce = function (A) {
            var e, t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 250, r = 2 < arguments.length && void 0 !== arguments[2] && arguments[2];
            return function () {
        ...
        A.exports = function (A) {
            ...
            var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
                ...
                return A.prototype.getValue = function (A) {
                    ...
                    var t, r = this, i = this.getValue(A), n = i.match(/\{[^\}]+?\}/g);
                    if (e && n)if ("object" === (void 0 === e ? "undefined" : o(e)))for (var a = 0; a < n.length; a++)t = n[a].substring(1, n[a].length - 1), i = i.replace(r.makeSafe(n[a]), e[t] || ""); else i = i.replace(/\{[^\}]+?\}/g, e);
                    return i
                    ...
                    return new Promise(function (t, r) {
                        if (e.langs[A])t(e.langs[A]); else {
                            var o = new XMLHttpRequest, i = e.config.location + A + e.config.extension;
        ...
        }(), l = t(6), s = r(l), c = t(29), u = r(c), f = function (A) {
            function e() {
                return o(this, e), i(this, A.apply(this, arguments))
            }

            return n(e, A), e.register = function () {
                var A = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : [];
        ...
        var a = function () {
            ...
            return n(e, A), e.prototype.build = function () {
                var A = this.config, e = A.value, t = void 0 === e ? "" : e, o = r(A, ["value"]);
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = e.instanceDom = {}, o = e.defaultSubtypes = {
            ...
            var t = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2], r = [], o = ["none", "block"];
            t && (o = o.reverse());
            ...
            return r
        }, a = e.optionFields = ["select", "checkbox-group", "checkbox", "radio-group", "autocomplete"], l = e.optionFieldsRegEx = new RegExp("(" + a.join("|") + ")");
        ...
        e.defaultOptions = {
            ...
            typeUserEvents: {},
            prefix: "form-builder-"
        }, e.styles = {btn: ["default", "danger", "info", "primary", "success", "warning"]}, e.defaultI18n = {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var o = t(77), i = r(o), n = t(78), a = r(n), l = t(35), s = r(l), c = t(80), u = r(c), f = t(81), g = r(f), d = t(82), p = r(d), w = t(54), m = r(w), b = t(79), B = r(b), h = t(36), I = r(h), E = t(84), M = r(E), y = t(83), Q = r(y);
        e.default = {
        ...
        var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
        ...
        }(), l = t(19), s = r(l), c = t(29), u = r(c), f = function () {
            function A(e, t) {
            ...
            return A.register = function (e, t, r) {
                ...
                var e = 0 < arguments.length && void 0 !== arguments[0] && arguments[0], t = Object.keys(A.classRegister);
                return t.length ? t.filter(function (A) {
                    return e ? -1 < A.indexOf(e + ".") : -1 == A.indexOf(".")
                }) : t
            }, A.getRegisteredSubtypes = function () {
                var e = {};
                for (var t in A.classRegister)if (A.classRegister.hasOwnProperty(t)) {
                    var r = t.split("."), o = r[0], i = r[1];
                    if (!i)continue;
                    e[o] || (e[o] = []), e[o].push(i)
                }
                return e
            }, A.getClass = function (e, t) {
                var r = t ? e + "." + t : e, o = A.classRegister[r] || A.classRegister[e];
                ...
                var t = this.definition, r = t.i18n || {};
                r = r[u.default.locale] || r.default || r;
                var o = this.camelCase(A), i = "object" == (void 0 === r ? "undefined" : n(r)) ? r[o] || r[A] : r;
                if (i)return i;
                var a = t.mi18n;
                ...
                var A = this.config, e = A.label, t = A.type, r = o(A, ["label", "type"]);
                ...
                var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "", t = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
            ...
            function A(e, t) {
                ...
                r(this, A), this.preview = t, this.templates = {
                    label: null, help: null, default: function (A, e, t, r) {
                        t && e.appendChild(t);
            ...
            return A.prototype.configure = function () {
                ...
                var r = new A(e, this.preview), i = r.build();
                "object" === (void 0 === i ? "undefined" : o(i)) && i.field || (i = {field: i});
                var a, l = this.label(), s = this.help();
                ...
                var A = this.data.label || "", e = n.default.parsedHtml(A), t = [e];
                return this.data.required && t.push(this.markup("span", "*", {className: "fb-required"})), this.isTemplate("label") ? this.processTemplate("label", t) : this.markup("label", t, {
                    for: this.data.id,
        ...
        (function (e, t) {
            !function (e) {
                "use strict";
                function r(A, e, t, r) {
                    var o = Object.create((e || i).prototype), n = new d(r || []);
                ...
                function c(A) {
                    ...
                    var r, o = e.bind(A, "next"), i = e.bind(A, "throw");
                    e.bind(A, "return");
                ...
                function u(A, e, t) {
                    ...
                    return function (i, n) {
                        ...
                        for (; ;) {
                            ...
                            if ("next" === i)t._sent = n, t.sent = r == M ? n : m; else if ("throw" === i) {
                                if (r == E)throw r = Q, n;
                ...
                function p(A) {
                    if (A) {
                        ...
                        if (!isNaN(A.length)) {
                            var t = -1, r = function e() {
                                for (; ++t < A.length;)if (b.call(A, t))return e.value = A[t], e.done = !1, e;
                ...
                var m, b = Object.prototype.hasOwnProperty, B = "function" == typeof Symbol && Symbol.iterator || "@@iterator", h = "object" == typeof A, I = e.regeneratorRuntime;
                if (I)return void(h && (A.exports = I));
                I = e.regeneratorRuntime = h ? A.exports : {}, I.wrap = r;
                var E = "suspendedStart", M = "suspendedYield", y = "executing", Q = "completed", C = {}, D = a.prototype = i.prototype;
                n.prototype = D.constructor = a, a.constructor = n, n.displayName = "GeneratorFunction", I.isGeneratorFunction = function (A) {
                    ...
                    constructor: d, reset: function (A) {
                        if (this.prev = 0, this.next = 0, this.sent = m, this.done = !1, this.delegate = null, this.tryEntries.forEach(g), !A)for (var e in this)"t" === e.charAt(0) && b.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = m)
                    }, stop: function () {
                        this.done = !0;
                        var A = this.tryEntries[0], e = A.completion;
                        ...
                        for (var t = this, r = this.tryEntries.length - 1; 0 <= r; --r) {
                            ...
                            if (o.tryLoc <= this.prev) {
                                var n = b.call(o, "catchLoc"), a = b.call(o, "finallyLoc");
                                if (n && a) {
                        ...
                        for (var t, r = this.tryEntries.length - 1; 0 <= r; --r)if (t = this.tryEntries[r], t.tryLoc <= this.prev && b.call(t, "finallyLoc") && this.prev < t.finallyLoc) {
                            var o = t;
                            break
                        }
                        ...
                        for (var e, t = this.tryEntries.length - 1; 0 <= t; --t)if (e = this.tryEntries[t], e.finallyLoc === A)return this.complete(e.completion, e.afterLoc), g(e), C
                    }, catch: function (A) {
                        for (var e, t = this.tryEntries.length - 1; 0 <= t; --t)if (e = this.tryEntries[t], e.tryLoc === A) {
                            var r = e.completion;
                            if ("throw" === r.type) {
                                var o = r.arg;
                                g(e)
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var a = t(6), l = function (A) {
            return A && A.__esModule ? A : {default: A}
        }(a), s = t(51), c = function (A) {
            function e() {
                return o(this, e), i(this, A.apply(this, arguments))
            }

            return n(e, A), e.prototype.build = function () {
                var A = this, e = this.config, t = e.values, o = e.type, i = r(e, ["values", "type"]), n = function (e) {
                    var t = e.target.nextSibling.nextSibling, r = e.target.nextSibling, o = A.getActiveOption(t), i = new Map([[38, function () {
                    ...
                    id: i.id + "-input", autocomplete: "off", events: {
                        focus: function (e) {
                            var t = e.target.nextSibling.nextSibling, r = (0, s.filter)(t.querySelectorAll("li"), e.target.value);
                            ...
                            if (0 == r.length)A.hideList(t); else {
                ...
                delete a.name;
                var c = [this.markup("input", null, a), this.markup("input", null, l)], u = t.map(function (e) {
                    var t = e.label, r = {
                        events: {
                            click: function (t) {
                                var r = t.target.parentElement, o = r.previousSibling.previousSibling;
        ...
        var n = function () {
            ...
            return i(e, A), e.prototype.configure = function () {
                ...
                var A = $(this.wrapper), e = $(this.input), t = $.extend(!0, {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var l = t(6), s = r(l), c = t(19), u = r(c), f = function (A) {
            function e() {
                return i(this, e), n(this, A.apply(this, arguments))
            }

            return a(e, A), e.prototype.build = function () {
                var A = this.config, e = A.type, t = o(A, ["type"]), r = {paragraph: "p", header: this.subtype};
                return r[e] && (e = r[e]), {
        ...
        var a = function () {
            ...
            return n(e, A), e.prototype.build = function () {
                var A = this, e = [], t = this.config, o = t.values, i = t.value, n = t.placeholder, a = t.type, l = t.inline, s = t.other, c = t.toggle, u = r(t, ["values", "value", "placeholder", "type", "inline", "other", "toggle"]), f = a.replace("-group", ""), g = "select" === a;
                if ((u.multiple || "checkbox-group" === a) && (u.name += "[]"), "checkbox-group" === a && u.required && (this.onRender = this.groupRequired), delete u.title, o) {
                    ...
                    for (var d, p = 0; p < o.length; p++) {
                        ...
                        var w = d, m = w.label, b = void 0 === m ? "" : m, B = r(w, ["label"]);
                        if (B.id = u.id + "-" + p, (!B.selected || n) && delete B.selected, void 0 !== i && B.value === i && (B.selected = !0), g) {
                            ...
                            var M = this.markup("input", null, Object.assign({}, u, B)), y = {for: B.id};
                    ...
                    if (!g && s) {
                        ...
                        }, F = this.markup("input", null, v), Y = [document.createTextNode("Other"), this.markup("input", null, N)], U = this.markup("label", Y, {for: v.id}), T = this.markup("div", [F, U], {className: x});
                        e.push(T)
                    }
                }
        ...
        var a = t(36), l = function (A) {
            ...
            return n(e, A), e.prototype.configure = function () {
                ...
                var A = this.config, e = (A.value, r(A, ["value"]));
                return this.field = this.markup("div", null, e), this.field
            }, e.prototype.onRender = function () {
                var A = this.config.value || "", e = window.Quill.import("delta");
